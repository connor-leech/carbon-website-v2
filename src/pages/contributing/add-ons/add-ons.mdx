...
<AnchorLinks>
    <AnchorLink>Add-on repositories</AnchorLink>
    <AnchorLink>Checklist</AnchorLink>
    <AnchorLink>Creating add-ons</AnchorLink>
    <AnchorLink>Contributing to add-ons</AnchorLink>
    <AnchorLink>Ownership</AnchorLink>
    <AnchorLink>Carbon support</AnchorLink>
</AnchorLinks>
